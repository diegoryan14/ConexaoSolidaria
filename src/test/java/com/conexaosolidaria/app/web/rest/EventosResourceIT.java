...
class EventosResourceIT {
    ...
    @Test
    @Transactional
    void getAllEventosByUsuarioIsEqualToSomething() throws Exception {
        Usuario usuario;
        ...
        // Get all the eventosList where usuario equals to usuarioId
        defaultEventosShouldBeFound("usuarioId.equals=" + usuarioId);

        // Get all the eventosList where usuario equals to (usuarioId + 1)
        defaultEventosShouldNotBeFound("usuarioId.equals=" + (usuarioId + 1));
    }
