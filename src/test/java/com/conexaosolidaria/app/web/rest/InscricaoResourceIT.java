...
class InscricaoResourceIT {
    ...
    @Test
    @Transactional
    void getAllInscricaosByUsuarioIsEqualToSomething() throws Exception {
        Usuario usuario;
        ...
        // Get all the inscricaoList where usuario equals to usuarioId
        defaultInscricaoShouldBeFound("usuarioId.equals=" + usuarioId);

        // Get all the inscricaoList where usuario equals to (usuarioId + 1)
        defaultInscricaoShouldNotBeFound("usuarioId.equals=" + (usuarioId + 1));
    }
