...
class AvaliacaoResourceIT {
    ...
    @Test
    @Transactional
    void getAllAvaliacaosByUsuarioIsEqualToSomething() throws Exception {
        Usuario usuario;
        ...
        // Get all the avaliacaoList where usuario equals to usuarioId
        defaultAvaliacaoShouldBeFound("usuarioId.equals=" + usuarioId);

        // Get all the avaliacaoList where usuario equals to (usuarioId + 1)
        defaultAvaliacaoShouldNotBeFound("usuarioId.equals=" + (usuarioId + 1));
    }
